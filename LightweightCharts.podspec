...
if [ "${CONFIGURATION}" = "Release" ]; then
    curl -o $LIBRARY https://unpkg.com/lightweight-charts@1.2.1/dist/lightweight-charts.standalone.production.js
else
    curl -o $LIBRARY https://unpkg.com/lightweight-charts@1.2.1/dist/lightweight-charts.standalone.development.js
fi
